...
static CGFloat const kDefaultTopPadding = 100;
static CGFloat const kDefaultUnderIconPadding = 20;
static CGFloat const kDefaultUnderTitlePadding = 10;
static CGFloat const kDefaultBottomPadding = 0;
static CGFloat const kDefaultUnderPageControlPadding = 0;
static CGFloat const kDefaultTitleFontSize = 24;
static CGFloat const kDefaultBodyFontSize = 18;
static CGFloat const kDefaultButtonFontSize = 14;
...
NSString * const kOnboardActionButtonAccessibilityIdentifiers = @"OnboardActionButtonAccessibilityIdentifier2";
